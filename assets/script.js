...
var questionArray = [
  {
    ...
    image: "<img src='assets\\images\\west_africa_map.png' class='responsive-img answer-img' alt='map of West Africa'>", // double \\ to escape the \ and make it render within the string literal of displayAnswer()
  ...
  },
  {
    ...
    image: "<img src='assets\\images\\Flag_of_Sierra_Leone_1916-1961.gif' class='responsive-img answer-img' alt='flag of Sierra Leone, 1916-1961'>",
  ...
  },
  {
    ...
    image: "<img src='assets\\images\\bunce.jpg' class='responsive-img answer-img' alt='18th-century woodcut of Bunce Island'>",
  ...
  },
  {
    ...
    image: "<img src='assets\\images\\cotton-tree.jpg' class='responsive-img answer-img' alt='Cotton Tree in Freetown'>",
  ...
  },
  {
    ...
    image: "<img src='assets\\images\\school.jpg' class='responsive-img answer-img' alt='A school near Koindu, damaged in the civil war'>",
  ...
  },
  {
    ...
    image: "<img src='assets\\images\\rice_farmer.jpg' class='responsive-img answer-img' alt='A Sierra Leonean rice farmer'>",
  ...
  },
  {
    ...
    image: "<img src='assets\\images\\krio-gullah.jpg' class='responsive-img answer-img' alt='Comparison of Krio and Gullah'>",
...
function displayAnswer(outcomeMessage, object) {
  ...
  $("#main-card").html(`
    <div id="main-card-content" class="card-content">
      ...
      <div class="center-align extra-margin answer-image">${object.image}</div>
